...
const pinAttributes = {
  IOVDD1: decoupledPowerPin,
  IOVDD2: decoupledPowerPin,
  IOVDD3: decoupledPowerPin,
  IOVDD4: decoupledPowerPin,
  IOVDD5: decoupledPowerPin,
  IOVDD6: decoupledPowerPin,
  DVDD1: decoupledPowerPin,
  DVDD2: decoupledPowerPin,
  DVDD3: decoupledPowerPin,
  ADC_AVDD: decoupledPowerPin,
  USB_OTP_VDD: decoupledPowerPin,
  QSPI_IOVDD: decoupledPowerPin,
...
export const RP2350A = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C42411118.obj?uuid=6af829ad488a4e1689b27543b3583581",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C42411118.step?uuid=6af829ad488a4e1689b27543b3583581",
        pcbRotationOffset: 0,
